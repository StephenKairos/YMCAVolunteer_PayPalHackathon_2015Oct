...
public class TabOneActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tab_one, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (currentUser != null) {
                ...
                ArrayID = (ArrayList<String>) currentUser.get("ActivityID");
            ...
            for (String id : ArrayID) {
                ...
                query.getInBackground(id, new GetCallback<ParseObject>() {
                    public void done(ParseObject object, ParseException e) {
                        if (e == null) {
                        // object will be your Activity
                            UserData data = new UserData(object.getInt("gradeLevel"), object.getInt("numberStudents"),
                                    object.getInt("hours"), object.getString("teacherName"),
                                    object.getString("location"), object.getString("bookName"),
                                    object.getString("comments"),object.getDate("volunteerDate"));
                        } else {
